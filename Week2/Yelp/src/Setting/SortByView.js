...
import {LIST_SORT_BY} from '../Lib/Constant';
import { UPDATE_SORT_BY } from './ActionType';

export default class SortByView extends Component {
  ...
  onValueChange = (value, option) => {
    let selected;
    if(!value){
      selected = { name: 'Best match', value: 'best_match'};
    }else {
      selected = option;
    }
    this.listItem.map(item => {
